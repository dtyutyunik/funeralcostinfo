# FuneralCostInfo — source ledger (model v2, built 2026-09-23)

## Formula

`state_estimate = NFDA 2023 national median × (state BEA 2024 RPP all-items ÷ 100)`
...
- **NFDA medians: 2023.** The 2023 Member General Price List Study remains the latest *published* NFDA price study. The NFDA said it would field the next GPL study in 2025, but as of 2026-09-23 no price results from a 2025 study had been published — and 2026 press coverage still cites the 2023 medians as current. We refresh anchors the moment a newer official study is published.
...
- **BLS CPI — Funeral expenses (+3.0% 12-month, August 2026)** (retrieved 2026-09-23)
